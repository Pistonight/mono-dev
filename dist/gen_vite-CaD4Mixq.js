import { _ as e, g as t, h as n, t as r, v as i } from "./plugins-Bv51fYNd.js";
...
var p = 4096, m = [
	...
	if (i.VERSION) if (typeof i.VERSION == "string") {
		...
		e("import.meta.env.VERSION: " + u), c.VERSION = JSON.stringify(u);
	} else {
		let t = String(n.version);
		e("import.meta.env.VERSION: " + t), c.VERSION = JSON.stringify(t);
	}
	if (i.COMMIT) {
		let t = s.spawnSync("git", ["rev-parse", "HEAD"], { encoding: "utf-8" }).stdout.trim();
		e("import.meta.env.COMMIT: " + t), c.COMMIT = JSON.stringify(t);
	}
	return c;
}, y = (e, t) => {
...
//# sourceMappingURL=gen_vite-CaD4Mixq.js.map