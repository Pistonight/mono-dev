...
var T = (e) => {
	...
	let t = i();
	if (t) if (!_.existsSync(e)) _.mkdirSync(e, { recursive: !0 }), _.writeFileSync(`${e}/version`, t);
	else {
		let r = !1;
		try {
	...
	for (let t in e) {
		...
		!a.startsWith("github:") || !a.endsWith("/mono-dev") || (e[t] = r + "#650a84fcce97288d81b3f0a6e28ee0e70ef7a8a8");
	}
}, B = {
